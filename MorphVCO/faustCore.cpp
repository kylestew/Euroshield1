...
faustCore::faustCore() : AudioStream((fDSP = new mydsp())->getNumInputs(), new audio_block_t*[fDSP->getNumInputs()])
{
    fUI = new MapUI();
...
void faustCore::setParamValue(const std::string& path, float value)
{
