...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = std::pow(0.00100000005f, (fConst2 / fSlow1));
		float fSlow3 = (fConst1 * (0.0f - (2.0f * fSlow2)));
		float fSlow4 = mydsp_faustpower2_f(fSlow2);
		int iSlow5 = (12 * int(float(fEntry1)));
		float fSlow6 = ftbl0mydspSIG0[iSlow5];
		float fSlow7 = std::pow(0.00100000005f, (fConst4 / fSlow1));
		float fSlow8 = (fConst3 * (0.0f - (2.0f * fSlow7)));
		float fSlow9 = mydsp_faustpower2_f(fSlow7);
		float fSlow10 = ftbl0mydspSIG0[(iSlow5 + 1)];
		float fSlow11 = std::pow(0.00100000005f, (fConst6 / fSlow1));
		float fSlow12 = (fConst5 * (0.0f - (2.0f * fSlow11)));
		float fSlow13 = mydsp_faustpower2_f(fSlow11);
		float fSlow14 = ftbl0mydspSIG0[(iSlow5 + 2)];
		float fSlow15 = std::pow(0.00100000005f, (fConst8 / fSlow1));
		float fSlow16 = (fConst7 * (0.0f - (2.0f * fSlow15)));
		float fSlow17 = mydsp_faustpower2_f(fSlow15);
		float fSlow18 = ftbl0mydspSIG0[(iSlow5 + 3)];
		float fSlow19 = std::pow(0.00100000005f, (fConst10 / fSlow1));
		float fSlow20 = (fConst9 * (0.0f - (2.0f * fSlow19)));
		float fSlow21 = mydsp_faustpower2_f(fSlow19);
		float fSlow22 = ftbl0mydspSIG0[(iSlow5 + 4)];
		float fSlow23 = std::pow(0.00100000005f, (fConst12 / fSlow1));
		float fSlow24 = (fConst11 * (0.0f - (2.0f * fSlow23)));
		float fSlow25 = mydsp_faustpower2_f(fSlow23);
		float fSlow26 = ftbl0mydspSIG0[(iSlow5 + 5)];
		float fSlow27 = std::pow(0.00100000005f, (fConst14 / fSlow1));
		float fSlow28 = (fConst13 * (0.0f - (2.0f * fSlow27)));
		float fSlow29 = mydsp_faustpower2_f(fSlow27);
		float fSlow30 = ftbl0mydspSIG0[(iSlow5 + 6)];
		float fSlow31 = std::pow(0.00100000005f, (fConst16 / fSlow1));
		float fSlow32 = (fConst15 * (0.0f - (2.0f * fSlow31)));
		float fSlow33 = mydsp_faustpower2_f(fSlow31);
		float fSlow34 = ftbl0mydspSIG0[(iSlow5 + 7)];
		float fSlow35 = std::pow(0.00100000005f, (fConst18 / fSlow1));
		float fSlow36 = (fConst17 * (0.0f - (2.0f * fSlow35)));
		float fSlow37 = mydsp_faustpower2_f(fSlow35);
		float fSlow38 = ftbl0mydspSIG0[(iSlow5 + 8)];
		float fSlow39 = std::pow(0.00100000005f, (fConst20 / fSlow1));
		float fSlow40 = (fConst19 * (0.0f - (2.0f * fSlow39)));
		float fSlow41 = mydsp_faustpower2_f(fSlow39);
		float fSlow42 = ftbl0mydspSIG0[(iSlow5 + 9)];
		float fSlow43 = std::pow(0.00100000005f, (fConst22 / fSlow1));
		float fSlow44 = (fConst21 * (0.0f - (2.0f * fSlow43)));
		float fSlow45 = mydsp_faustpower2_f(fSlow43);
		float fSlow46 = ftbl0mydspSIG0[(iSlow5 + 10)];
		float fSlow47 = std::pow(0.00100000005f, (fConst24 / fSlow1));
		float fSlow48 = (fConst23 * (0.0f - (2.0f * fSlow47)));
		float fSlow49 = mydsp_faustpower2_f(fSlow47);
		float fSlow50 = ftbl0mydspSIG0[(iSlow5 + 11)];
		for (int i = 0; (i < count); i = (i + 1)) {
			fVec0[0] = fSlow0;
			float fTemp0 = (fSlow0 - fVec0[1]);
			float fTemp1 = (fTemp0 * float((fTemp0 > 0.0f)));
			fRec0[0] = (fTemp1 - ((fSlow3 * fRec0[1]) + (fSlow4 * fRec0[2])));
			fRec1[0] = (fTemp1 - ((fSlow8 * fRec1[1]) + (fSlow9 * fRec1[2])));
			fRec2[0] = (fTemp1 - ((fSlow12 * fRec2[1]) + (fSlow13 * fRec2[2])));
			fRec3[0] = (fTemp1 - ((fSlow16 * fRec3[1]) + (fSlow17 * fRec3[2])));
			fRec4[0] = (fTemp1 - ((fSlow20 * fRec4[1]) + (fSlow21 * fRec4[2])));
			fRec5[0] = (fTemp1 - ((fSlow24 * fRec5[1]) + (fSlow25 * fRec5[2])));
			fRec6[0] = (fTemp1 - ((fSlow28 * fRec6[1]) + (fSlow29 * fRec6[2])));
			fRec7[0] = (fTemp1 - ((fSlow32 * fRec7[1]) + (fSlow33 * fRec7[2])));
			fRec8[0] = (fTemp1 - ((fSlow36 * fRec8[1]) + (fSlow37 * fRec8[2])));
			fRec9[0] = (fTemp1 - ((fSlow40 * fRec9[1]) + (fSlow41 * fRec9[2])));
			fRec10[0] = (fTemp1 - ((fSlow44 * fRec10[1]) + (fSlow45 * fRec10[2])));
			fRec11[0] = (fTemp1 - ((fSlow48 * fRec11[1]) + (fSlow49 * fRec11[2])));
			output0[i] = FAUSTFLOAT((0.0416666679f * (((((((((((((fRec0[0] - fRec0[2]) * fSlow6) + ((fRec1[0] - fRec1[2]) * fSlow10)) + ((fRec2[0] - fRec2[2]) * fSlow14)) + ((fRec3[0] - fRec3[2]) * fSlow18)) + ((fRec4[0] - fRec4[2]) * fSlow22)) + ((fRec5[0] - fRec5[2]) * fSlow26)) + ((fRec6[0] - fRec6[2]) * fSlow30)) + ((fRec7[0] - fRec7[2]) * fSlow34)) + ((fRec8[0] - fRec8[2]) * fSlow38)) + ((fRec9[0] - fRec9[2]) * fSlow42)) + ((fRec10[0] - fRec10[2]) * fSlow46)) + ((fRec11[0] - fRec11[2]) * fSlow50))));
			fVec0[1] = fVec0[0];
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
			fRec1[2] = fRec1[1];
